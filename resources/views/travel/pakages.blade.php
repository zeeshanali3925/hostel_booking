...
@section('content')
    ...
    <div class="relative text-white py-24 px-6 text-center">
        ...
        <div class="relative z-10">
            <h1 class="text-5xl font-extrabold mb-4">Explore Our Best Travel Packages</h1>
            <p class="text-lg max-w-2xl mx-auto mb-6">
                Discover hand-picked vacation deals, perfect for every kind of traveler. Book your next adventure with us!
            </p>
            <a href="{{ route('packages.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                Get Started
            </a>
        </div>
    </div>
